...
6. `POST /api/chat` envia mensagem para o modelo e retorna resposta (requer autenticacao).
7. `POST /api/chat/stream` envia mensagem e retorna a resposta em streaming SSE (requer autenticacao).
